...
- **The permission guide stops waiting after ten minutes** — It previously polled once a second for as long as it was open, indefinitely. It now gives up and says so, with a "Check again" button, rather than either probing forever or going quiet and leaving you to wonder why nothing happened when you granted permission. (BL-085)
